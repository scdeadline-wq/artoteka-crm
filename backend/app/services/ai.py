...
{
  "title": "Реальное название работы, если ты его уверенно узнал из визуальных признаков (подпись, известная композиция). НЕ ВЫДУМЫВАЙ названия. Если не знаешь точно — null. Пользователь введёт сам.",
  "artist_name": "Имя художника (Фамилия Имя) на русском, ТОЛЬКО если уверенно узнал по подписи, манере или известной работе. НЕ предполагай и не пиши '(предположительно)'. Если не уверен — null.",
