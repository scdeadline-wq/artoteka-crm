...
Получаешь свободный текст на русском (может быть из голосового сообщения, с ошибками распознавания).
...

{
  ...
  "year": 2024 или null,
  "technique": "Техника как сказано в описании (напр. 'масло, холст') или null",
  "width_cm": 60 или null,
  "height_cm": 80 или null,
  "sale_price": 180000 или null,
  "edition": "Тираж типа '12/50' или null",
  "location": "Место хранения или null",
  "notes": "Прочее что было сказано но не легло в поля выше, или null"
}

Не выдумывай. Если поля нет в описании — null."""
